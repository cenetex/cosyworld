...
mod tests {
    ...
    fn upgrade_requires_the_exact_declared_migration_tuple() {
        ...
        assert!(
            generation_policy_allows_upgrade(&production_core, "1.3.14").is_ok(),
        ...
        assert!(
            generation_policy_allows_upgrade(&production_core_current_policy, "1.3.14").is_ok(),
        ...
        assert!(
            generation_policy_allows_upgrade(&undeclared_core, "1.3.14").is_err(),
