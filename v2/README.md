...
- The browser appends room speech and shared story beats to the room transcript. Paired events are folded into one readable beat, combat keeps its compact combat history, and the location's Journal keeps the longer history. Lantern Keeper actions additionally end in one persisted `story.receipt`.
