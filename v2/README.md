...
- The browser keeps the room transcript for committed speech, images, and reflections. Card outcomes, rolls, movement, and other shared history stay out of chat; live turn or combat state uses one compact status, and longer history remains in the Journal and canonical event record. Lantern Keeper actions additionally end in one persisted `story.receipt`.
