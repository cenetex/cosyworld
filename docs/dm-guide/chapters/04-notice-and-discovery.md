...
::: {.target}
**ACCEPTED TARGET - Shared discovery reducer.** The six states, Discovery
Slots, Leads, Gates, Hazards, and Pressure form the decided design. Current
content already has deterministic discovery and loot receipts, but not every
subject uses this unified procedure yet.
:::
