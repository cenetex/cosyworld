...
- The resting UI is one action controller: exactly two labeled, server-derived suggestions plus certified Think/Pass; no permanent composer, send button, or navigation sidebar. Every successful play, including Pass, spends one turn; free redeal aliases are refused.
